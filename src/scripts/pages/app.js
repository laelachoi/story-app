...
import {
  generateAuthenticatedNavigation,
  generateUnauthenticatedNavigation,
...
export default class App {
  ...
  #setupNavigationList() {
    ...
    if (!isLogin) {
      ...
      navList.innerHTML = generateUnauthenticatedNavigation();
      return;
    }

    navListMain.innerHTML = generateMainNavigation();
    navList.innerHTML = generateAuthenticatedNavigation();
